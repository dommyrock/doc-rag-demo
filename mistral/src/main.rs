...
use lib::{hub_load_safetensors, token_output_stream::TokenOutputStream};
...
fn main() -> Result<()> {
    ...
    let (model, device) = if args.quantized {
        ...
        //     DType::BF16 //Error: DriverError(CUDA_ERROR_NOT_FOUND, "named symbol not found") when loading cast_u32_bf16
        // } else {
        //     DType::F32
        // };
